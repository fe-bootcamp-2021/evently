      ...
      <div className="w-8/12 mx-auto h-screen flex justify-around my-12">
        ...
        <div>
          <div className="border border-blue-900 relative rounded-full">
            <label>
              {image.preview ? (
                <img className="w-56 h-56 rounded-full object-cover object-center" src={image.preview} alt="dummy" />
              ) : (
                <img className="w-56 h-56 rounded-full object-cover object-center" src="https://static.wixstatic.com/media/b17c62_326cef80bf1b44dd956aca581b0530f7~mv2.jpg/v1/crop/x_235,y_0,w_1069,h_1069/fill/w_544,h_544,al_c,q_80,usm_0.66_1.00_0.01/kemptons-blank-profile-picture.webp" alt="dummy" />
              )}
            </label>
        ...
        <div className=" flex flex-col my-2 ml-2">
          ...
          <div className="-mx-3 md:flex mb-6">
            <div className="md:w-full px-3">
              ...
              <Input className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" id="grid-password" type="text" placeholder="E-mail" />
            </div>
          </div>
